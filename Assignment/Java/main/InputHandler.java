...
public class InputHandler implements KeyListener {
	...
	private void toggle(KeyEvent ke, boolean pressed) {
		...
		*/
		if (ke.getKeyCode() == KeyEvent.VK_ENTER) enter.toggle(pressed); //press Enter, attack toggled

		if (ke.getKeyCode() == KeyEvent.VK_Z) z.toggle(pressed); // press C, attack toggled
		if (ke.getKeyCode() == KeyEvent.VK_X) x.toggle(pressed); //press X, menu toggled
	}
